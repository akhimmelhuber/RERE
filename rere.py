...
from evaluation import XCollector
    ...
    if prog_args.explain_node is None:
       ...
       if graph_mode:
            if prog_args.graph_idx == 3:
                ...
                experiment.train_policy([590], prog_args)
           
       else:       
                # Train Policy for Node Classification GCN
                masked_adj = experiment.train_policy([312, 322, 342, 302], prog_args)
